    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                section("AI analysis") {
                    "Emotional insights and transcript cleanup are generated by a small AI model that runs entirely on this device. Your entry's text is never sent to a server or a third party to produce it — nothing leaves your device for this or any other feature in Sotto."
                }
